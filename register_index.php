                                ...
                                if(mysqli_num_rows($user_check)==0){
                                    $email_check=mysqli_query($admin_dbcon,"SELECT * FROM `from` WHERE `email`='$email'");     
                                        if(mysqli_num_rows($email_check)==0){
                                            ...
                                            $insert_query=mysqli_query($admin_dbcon,"INSERT INTO `from`( `username`, `email`, `mobile`, `password`, `reg_time`, `status`) VALUES ('$username','$email','$mobile','$password','$reg_time','Inactive')");
                                                if($insert_query){
                                                    echo '<script>
